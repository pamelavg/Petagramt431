...
public class InfoMascotaAdapter extends RecyclerView.Adapter<InfoMascotaAdapter.MascotaViewHolder>{

    public InfoMascotaAdapter(ArrayList<Mascota> mascotas)
    {
    ...
    public MascotaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.info_cardview_mascota,parent,false);
